...
- まず最初の縦切りを早めに作る
- 最初の縦切りとは、1 つの Web shell route と 1 つの parser 駆動レビュー経路を end-to-end で通すことを指す
...
- analysis contract を固める前に、広いプロダクト面・外部連携・persistence model まで先に進める
...
3. 実際の pull request 由来の fixture を追加し、最初の Web shell を超えて広げる前に精度を評価する。
