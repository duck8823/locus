...
import { groupArchitectureNodes } from "@/server/presentation/formatters/architecture-node";
import {
  formatCodeRegion,
...
export default async function ReviewWorkspacePage({
  ...
  const architectureColumns: ArchitectureColumn[] = selectedGroup
    ? buildArchitectureColumns(selectedGroup.architectureGraph, selectedGroup.groupId)
    : [];
